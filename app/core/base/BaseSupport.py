...
from app.modules.admin.models import AdminPermission, AdminRole, IpRule, AdminAuditLog
from app.modules.admin.repositories import AdminAuditLogRepository, AdminIdentityRepository
...
def audit_admin_action(
    ...
    if not settings.admin_audit_enabled:
        return
    AdminAuditLogRepository(db).create(
        AdminAuditLog(
...
def model_data(model) -> dict[str, Any]:
    data: dict[str, Any] = {}
...
def maintenance_data(state) -> dict[str, Any]:
    data = {
